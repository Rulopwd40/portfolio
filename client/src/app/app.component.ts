...
export class AppComponent {
  ...
  projects = [
    { 
      name: 'Forge',
      url: 'https://github.com/Rulopwd40/Forge',
      description: "Workouts generator (WIP)",
      technology: 'Golang Angular'
    },
    { 
    ...
    },
    {
      ...
      url: 'https://github.com/gonzalo-aguero/delivery-management-system',
      description: 'MVP where my principal role was the creation of the API, business logic with services, and JPARepositories',
      technology: 'Java Springboot Hibernate'
    },
    { 
